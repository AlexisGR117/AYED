class BinaryTree:
    ...
    def __str__(self):
        if self.left_tree is not None and self.right_tree is not None and self.get_higher() is not None:
            return "Leaf(" + str(self.left_tree.root) + ", " + str(self.root) + ", " + str(self.right_tree.root) + ", " + str(self.stored_value) + ", " + str(self.get_higher().root) + ", " + str(self.balance_factor) + ')'
        elif self.left_tree is not None and self.right_tree is not None:
            return "Leaf(" + str(self.left_tree.root) + ", " + str(self.root) + ", " + str(self.right_tree.root) + ", " + str(self.stored_value) + ", None, " + str(self.balance_factor) + ')'
        elif self.left_tree is not None and self.get_higher() is not None:
            return "Leaf(" + str(self.left_tree.root) + ", " + str(self.root) + ", None, " + str(self.stored_value) + ", " + str(self.get_higher().root) + ", " + str(self.balance_factor) + ')'
        elif self.right_tree is not None and self.get_higher() is not None:
            return "Leaf(" + "None, " + str(self.root) + ", " + str(self.right_tree.root) + ", " + str(self.stored_value) + ", " + str(self.get_higher().root) + ", " + str(self.balance_factor) + ')'
        elif self.right_tree is not None:
            return "Leaf(" + "None, " + str(self.root) + ", " + str(self.right_tree.root) + ", " + str(self.stored_value) + ", None, " + str(self.balance_factor) + ')'
        elif self.left_tree is not None:
            return "Leaf(" + str(self.left_tree.root) + ", " + str(self.root) + ", None, " + str(self.stored_value) + ", None, " + str(self.balance_factor) + ')'
        else:
            return "Leaf(" + "None, " + str(self.root) + ", None, " + str(self.stored_value) + ", " + str(self.get_higher().root) + ", " + str(self.balance_factor) + ')'
