...
class LinkedList:
    ...
    def search(self, value):
        """
        Funcion que dado un elemento cualquiera, si esta en la lista enlazada
    ...
    def search_prev(self, value):
        """
        Funcion que dado un elemento cualquiera, si esta en la lista enlazada
        se devuelve el nodo previo al elemento
        (LinkedList, any) -> (Node)
        """
        if self.is_empty():
            return None
    ...
    def delete_element(self, value):
        """
        Funcion que dado un elemento cualquiera, si esta en la lista enlazada se elimina de esta
        (LinkedList, any) -> (Node)
        """
